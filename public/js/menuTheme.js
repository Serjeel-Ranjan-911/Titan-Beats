...
const switchTheme = () => {
    if (theme === "light") {
        ...
        root.style.setProperty("--shadow-down", "inset 4.5px 4.5px 9px #cbcbcb, inset -4.5px -4.5px 9px #ffffff;");
        ...
        root.style.setProperty(
            "--shadow-down",
            "inset 6px 6px 12px #0e0e0e, inset -4px -4px 10px rgba(95, 94, 94, 0.25)"
        );
